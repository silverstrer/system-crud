                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">
                            <label>Kelas</label>
                            <select type="text" name="address" class="form-select-lg" aria-label="Default select example">
                        ...
                        <div class="form-group <?php echo (!empty($salary_err)) ? 'has-error' : ''; ?>">
                            <label>L/P</label>
                            <select type="text" name="salary" class="form-select px-3 py-3" aria-label="Default select example">
